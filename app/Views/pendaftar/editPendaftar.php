                    ...
                    <div class="form-section current" id="section1">
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <input type="text" name="nama" class="form-control" autocomplete="off" value="<?= $dftr['nama']; ?>" data-section="1">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Jenis Kelamin </label>
                                <span style="color: red;">*</span>
                                <select name="jenisKel" id="inputState" class="form-control" data-section="1">
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="tempatLahir" class="form-control" autocomplete="off" value="<?= $dftr['tempatLahir']; ?>" data-section="1">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Tanggal Lahir </label>
                                <span style="color: red;">*</span>
                                <input type="date" name="tanggalLahir" class="form-control" max="<?= date('Y-m-d', strtotime('-13 years')); ?>" data-section="1" min="<?= date('Y-m-d', strtotime('-15 years')); ?>" data-section="1" value="<?= $dftr['tanggalLahir']; ?>">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="nisn" class="form-control" autocomplete="off" value="<?= $dftr['nisn']; ?>" data-section="1">
                            </div>

                            <div class="col">
                                <label class="col-form-label">NIK </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="nik" class="form-control" min=0 autocomplete="off" value="<?= $dftr['nik']; ?>" data-section="1">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="anakKe" class="form-control" autocomplete="off" value="<?= $dftr['anakKe']; ?>" data-section="1">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Jumlah Saudara (Gunakan Angka)</label>
                                <span style="color: red;">*</span>
                                <input type="text" name="jumlahSaudara" class="form-control" min=0 autocomplete="off" value="<?= $dftr['jumlahSaudara']; ?>" data-section="1">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="alamat" class="form-control" autocomplete="off" value="<?= $dftr['alamat']; ?>" data-section="1">
                            </div>

                            <div class="col">
                                <label class="col-form-label">No Telepon</label>
                                <span style="color: red;">*</span>
                                <input type="text" name="noTelp" class="form-control" min=0 autocomplete="off" value="<?= $dftr['noTelp']; ?>" data-section="1">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="sekolahAsal" class="form-control" autocomplete="off" value="<?= $dftr['sekolahAsal']; ?>" data-section="1">
                            </div>
                        </div>
                    ...
                    <div class="form-section" id="section2">
                        ...
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="namaAyah" class="form-control" autocomplete="off" value="<?= $dftr['namaAyah']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Nama Ibu </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="namaIbu" class="form-control" min=0 autocomplete="off" value="<?= $dftr['namaIbu']; ?>" data-section="2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="pekerjaanAyah" class="form-control" autocomplete="off" value="<?= $dftr['pekerjaanAyah']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Pekerjaan Ibu </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="pekerjaanIbu" class="form-control" min=0 autocomplete="off" value="<?= $dftr['pekerjaanIbu']; ?>" data-section="2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="nikAyah" class="form-control" autocomplete="off" value="<?= $dftr['nikAyah']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">NIK Ibu </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="nikIbu" class="form-control" min=0 autocomplete="off" value="<?= $dftr['nikIbu']; ?>" data-section="2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="penghasilanOrtu" class="form-control" autocomplete="off" value="<?= $dftr['penghasilanOrtu']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Agama Ortu </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="agamaOrtu" class="form-control" min=0 autocomplete="off" value="<?= $dftr['agamaOrtu']; ?>" data-section="2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="alamatOrtu" class="form-control" autocomplete="off" value="<?= $dftr['alamatOrtu']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Pendidikan </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="pendidikan" class="form-control" min=0 autocomplete="off" value="<?= $dftr['pendidikan']; ?>" data-section="2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="namaWali" class="form-control" autocomplete="off" value="<?= $dftr['namaWali']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Pekerjaan Wali </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="pekerjaanWali" class="form-control" min=0 autocomplete="off" value="<?= $dftr['pekerjaanWali']; ?>" data-section="2">
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <input type="text" name="agamaWali" class="form-control" autocomplete="off" value="<?= $dftr['agamaWali']; ?>" data-section="2">
                            </div>

                            <div class="col">
                                <label class="col-form-label">Alamat Wali </label>
                                <span style="color: red;">*</span>
                                <input type="text" name="alamatWali" class="form-control" min=0 autocomplete="off" value="<?= $dftr['alamatWali']; ?>" data-section="2">
                            </div>
                        </div>
                    ...
                    <div class="form-section" id="section3">
                        ...
                        <div class="form-row">
                            ...
                            <div class="col">
                                ...
                                <span style="color: red;">*</span>
                                <select name="status_daftar" id="inputState" class="form-control" data-section="1">
                    ...
                    <div class="form-section" id="section4">
                        ...
                        <div class="form-row" style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="form-group mt-2 mb-3 col-6">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFilePasFoto" name="pasfoto" onchange="updateFileName('exampleInputFilePasFoto', 'fileLabelPasFoto')" data-section="4">
                            ...
                            <div class="form-group mt-2 mb-3 col-6">
                                ...
                                <span style="color: red;">*</span>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFileAkta" name="aktaKelahiran" onchange="updateFileName('exampleInputFileAkta', 'fileLabelAkta')" data-section="4">
                        ...
                        <div class="form-row" style="display: flex; justify-content: space-between; align-items: center;">
                            <div class="form-group mt-2 mb-3 col-6">
                                ...
                                <span style="color: red;">*</span>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFileKK" name="KK" onchange="updateFileName('exampleInputFileKK', 'fileLabelKK')" data-section="4">
                            ...
                            <div class="form-group mt-2 mb-3 col-6">
                                ...
                                <span style="color: red;">*</span>
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" id="exampleInputFileIjazah" name="ijazahSD" onchange="updateFileName('exampleInputFileIjazah', 'fileLabelIjazah')" data-section="4">
