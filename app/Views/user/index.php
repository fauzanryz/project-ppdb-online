                    ...
                    <tbody style="text-align: center;">
                        ...
                        <?php foreach ($user as $usr) : ?>
                            <tr>
                                ...
                                <td>
                                    <?php if (session()->get('level') == 1) : ?>
                                        <a href="<?= base_url('/kelolaUser/detail' . '/' . $usr['idUser']) ?>" class="btn btn-success" data-toggle="modal" data-target="#modal-default"><i class="fas fa-eye"></i></a>
                                        ...
                                        <form action="<?= base_url('/kelolaUser/hapus' . '/' . $usr['idUser']); ?>" class="d-inline" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-danger" onclick="return confirm('Apakah Anda yakin ingin menghapus user ini?')"><i class="fas fa-trash-alt"></i></button>
                                        </form>
