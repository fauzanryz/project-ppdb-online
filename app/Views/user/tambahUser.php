	...
	<div class="container-fluid">
		...
		<div class="card card-primary">
			<div class="card-body">
				...
				<form method="POST" action="<?= base_url('/kelolaUser/tambahUser'); ?>" enctype="multipart/form-data">
					<?= csrf_field(); ?>
					...
					<div class="form-row">
						...
						<div class="col">
							...
							<input type="text" name="username" class="form-control" min=0 autocomplete="off" value="<?= old('username'); ?>">
						</div>
					</div>
					...
					<div class="form-group mt-2 mb-3">
						...
						<div class="custom-file">
							...
							<label class="custom-file-label" id="fileLabel" for="exampleInputFile"></label>
						</div>
					</div>
